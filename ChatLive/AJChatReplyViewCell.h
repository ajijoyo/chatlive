...
#import "AJQuoteChat.h"
#import "AJChatMessage.h"
#import "SelfSizingMaxWidthCollectionViewCell.h"

@interface AJChatReplyViewCell : SelfSizingMaxWidthCollectionViewCell
@property (weak, nonatomic) IBOutlet UILabel *messageLabel;
@property (weak, nonatomic) IBOutlet AJQuoteChat *quoteView;
